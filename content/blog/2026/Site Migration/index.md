...
date: 2026-09-21
description: The Website has been migrated to three.js and hugo
...
This creates the benefit, that if the CASSA severs ever go down or their internet connection drops, the website can still run, increasing the [cassa.au](https://cassa.au/) uptime.

## New Website

The new CASSA website is now split into two main sections:

1. [The Dynamic Site](https://cassa.au/).
